...
class DocumentProcessor:
    ...
    async def _process_docx(self, file_path: str, session_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                logger.warning(f"Agno DOCX processing failed: {agno_error}, trying python-docx")
    ...
    async def _create_document_embeddings(
        ...
        try:
            ...
            self.doc_vector_db.upsert(
                documents=documents,
                metadatas=metadatas,
                ids=ids
            )
            
            logger.info(f"✅ Created embeddings for {len(chunks)} chunks from {filename}")
